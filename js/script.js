...
function init(){
    ...
    var st = new $jit.ST({
        ...
        //set tree orientation. Possible values are "top", "left", 
        //"right" and "bottom".
        orientation: "top",
        ...
        onCreateLabel: function(label, node){
            ...
            style.color = '#000'; // #FFF
            if (node._depth == 0) style.color = backgroundColor;
        ...
        onBeforePlotLine: function(adj){
            ...
            if (adj.nodeFrom._depth == 0) {
                adj.data.$color = backgroundColor;
            }
        }
    });
    //load json data
